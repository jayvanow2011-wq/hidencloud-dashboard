...
type Panel = "screen" | "camera" | "files" | "shell";
...
function fakeShell(cmd: string): string {
  ...
  if (c === "dir" || c === "ls") return "Desktop  Documents  Downloads  passwords.txt";
  if (c === "whoami") return "desktop-jay\\jay";
  if (c.startsWith("echo ")) return cmd.slice(5);
  if (c === "help") return "Commands: dir, whoami, echo <msg>, cls, help";
  if (c === "cls") return "";
